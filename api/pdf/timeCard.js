    ...
    TimeCardForm.find(_id, (err, result) => {
      ...
      //} else if ( email === result.email) {
        ...
        generatePdf(docDefinition, (response) => {
          ...
          res.json(response) // sends a base64 encoded string to client
        });
...
module.exports = { getPDFTimeHourForm }
